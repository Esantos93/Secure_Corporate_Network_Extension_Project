...
REMOTE_DIR="/tmp/openvpncl"
SCRIPT_SETUP="london_ovpn_setup.sh"
...
scp -i "~/.ssh/bnss" "easy-rsa/easyrsa3/pki/issued/client-g6.crt" "$ROUTER_USER@$ROUTER_IP:$REMOTE_DIR/cert.pem"
scp -i "~/.ssh/bnss" "easy-rsa/easyrsa3/pki/private/client-g6.key" "$ROUTER_USER@$ROUTER_IP:$REMOTE_DIR/key.pem"
